...
> Índice en tiempo real de frameworks de agentes LLM en GitHub, actualizado cada 15 minutos
...
Un tracker que se actualiza solo y descubre e indexa nuevos frameworks de agentes LLM a medida que aparecen en GitHub. A diferencia de las awesome-lists estáticas que quedan obsoletas en semanas, este proyecto usa GitHub Actions para escanear continuamente nuevos repos, clasificarlos por señales de actividad y publicar un feed estructurado que los devs pueden consultar o explorar.
