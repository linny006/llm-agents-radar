...
| 22 | [xiaomaozjj666/data-analysis-agent](https://github.com/xiaomaozjj666/data-analysis-agent) | 1 | Python | 2026-08-14 | 基于 LLM 的端到端数据分析工作台：上传数据集即可自动完成清洗、统计分析、可视化与报告生成，支持本地、Docker 与云端部署。 |
...
| 24 | [SuperdeMan/cockpit-agent](https://github.com/SuperdeMan/cockpit-agent) | 10 | Python | 2026-08-14 | 面向智能座舱的云边协同 AI Agent：端侧毫秒级车控，云端声明式 Multi-Agent 与 Skill/DAG 编排，支持 S2S 实时语音、声纹多用户、视觉与 HMI；LLM 只负责理解与规划，VAL 负责确定性安全执行。 |
| 25 | [Om-Khode/TENKA](https://github.com/Om-Khode/TENKA) | 7 | Python | 2026-08-14 | Transformative Evolving Neural Kinetic Agent - a local-first Python voice agent for Windows. |
| 26 | [gaoming-a/OppScout-showcase](https://github.com/gaoming-a/OppScout-showcase) | 0 | — | 2026-08-14 | Evidence-grounded product opportunity research system: Agentic RAG, DeepResearch, multi-agent review, and evaluation. |
| 27 | [HKUDS/DeepCode](https://github.com/HKUDS/DeepCode) | 16356 | Python | 2026-08-14 | "DeepCode: Open Agentic Coding ((Agent Harness & Loop Engineering & Multi-Agent Orchestration)" |
| 28 | [ChaoyuWang04/Syncopate_Async_AgenticRL](https://github.com/ChaoyuWang04/Syncopate_Async_AgenticRL) | 0 | Python | 2026-08-14 | Sync vs fully-async agentic RL on verl: multi-turn GRPO, long-tail rollout profiling, staleness ablations — quantifying  |
| 29 | [862930522/opencode-anchored-standard](https://github.com/862930522/opencode-anchored-standard) | 0 | JavaScript | 2026-08-14 |  |
...
| 31 | [edjafarov/kiagent-core](https://github.com/edjafarov/kiagent-core) | 7 | TypeScript | 2026-08-14 | kiagent-core — open-source personal AI brain — local, open source, speaks MCP |
| 32 | [kangkukjin/indiebizOS](https://github.com/kangkukjin/indiebizOS) | 4 | Python | 2026-08-14 | A personal AI OS you grow yourself — natural language compiles to a real action language, runs on desktop & phone |
...
| 35 | [y0usaf/pi-rs](https://github.com/y0usaf/pi-rs) | 0 | Rust | 2026-08-14 | Pi's coding agent ported to Rust |
| 36 | [adityaarsharma/pickle](https://github.com/adityaarsharma/pickle) | 3 | JavaScript | 2026-08-14 | Free, local, open-source MCP server that audits your ClickUp, Slack & Teams for what fell through the cracks — stale tas |
| 37 | [dkblinux98/nyxGPT](https://github.com/dkblinux98/nyxGPT) | 0 | Python | 2026-08-14 | Local-first, private ChatGPT-style AI system that runs entirely on your own machine. Ollama-powered LLM inference, persi |
| 38 | [bajshorya/llm-observability-agent](https://github.com/bajshorya/llm-observability-agent) | 0 | TypeScript | 2026-08-14 | Detects runtime anomalies from application logs, correlates them with recent commits, and generates root-cause hypothese |
...
| 40 | [ljchang/mecha](https://github.com/ljchang/mecha) | 3 | Rust | 2026-08-14 | A standalone agent harness in Rust: a provider-agnostic loop, MCP tools, a path jail and prompt-injection interlock, san |
| 41 | [denn-gubsky/loomcycle](https://github.com/denn-gubsky/loomcycle) | 13 | Go | 2026-08-14 | The runtime substrate for agentic systems — one Go binary, six LLM providers, MCP-native, configurable as a managed sand |
| 42 | [alex8224/synapse-agent](https://github.com/alex8224/synapse-agent) | 8 | Python | 2026-08-14 |  Where intent meets code — a local AI coding agent          |
| 43 | [ConradLu2740/pa-dsh](https://github.com/ConradLu2740/pa-dsh) | 1 | JavaScript | 2026-08-14 | ProactiveAgent × DeepSeek Harness 插件组：把主动记忆 + 主动建议接入 DSH（6 个 cordis 插件，引擎零重写） |
| 44 | [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | 28947 | Python | 2026-08-14 | Build and run agents you can see, understand and trust. |
| 45 | [shanananana/deepticket](https://github.com/shanananana/deepticket) | 3 | Python | 2026-08-14 | Self-hosted SRE orchestration for business teams: MCP + logs + config + ITSM, no platform conflict · 业务组内网 · 薄编排层 · on-c |
| 46 | [AndriiLavrekha/awesome-progress-tracker](https://github.com/AndriiLavrekha/awesome-progress-tracker) | 0 | TypeScript | 2026-08-14 | Project-local Markdown progress tracking for Codex, Claude Code, and MCP-compatible agents — resumable memory across ses |
| 47 | [eshanized/M31A](https://github.com/eshanized/M31A) | 8 | Go | 2026-08-14 | The terminal-native AI coding agent that ships, not just suggests. Six-phase workflow, git rollback chain, zero telemetr |
| 48 | [TirthBorasaniya/agent-roi-console](https://github.com/TirthBorasaniya/agent-roi-console) | 0 | Python | 2026-08-14 | Full-stack multi-agent automation platform that converts LangGraph workflow runs into net ROI and per-tool cost attribut |
| 49 | [Smana/runlore](https://github.com/Smana/runlore) | 12 | Go | 2026-08-14 | The self-improving SRE agent |
| 50 | [helixml/helix](https://github.com/helixml/helix) | 797 | Go | 2026-08-14 | ♾️ Private Agent Fleet with Spec Coding. Each agent gets their own GPU-accelerated desktop. Run Claude, Codex, Gemini an |
<!-- TRACKER_TABLE_END -->
