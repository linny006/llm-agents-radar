...
| 10 | [S3YED/appie-kit](https://github.com/S3YED/appie-kit) | 6 | Python | 2026-08-11 | Build Your Own AI Employee. The complete starter kit for OpenClaw + Hermes Agent. 155 deduplicated skills, drag-and-drop |
...
| 12 | [tomcounsell/ai](https://github.com/tomcounsell/ai) | 22 | Python | 2026-08-11 | A productive AI coworker that learns, self-improves, and ships work. |
| 13 | [acmiyaguchi/fen-web](https://github.com/acmiyaguchi/fen-web) | 0 | TypeScript | 2026-08-11 | Browser-resident fen: WASM demo + extension, consuming fen core as a submodule (fen#99) |
| 14 | [HaD0Yun/CozyClay](https://github.com/HaD0Yun/CozyClay) | 50 | JavaScript | 2026-08-11 | Browser-based 3D staging studio: scene blocking, character posing, prompt-block sequencing, and ARDY motion preview. |
...
| 16 | [the-priest/PriestsBasilisk](https://github.com/the-priest/PriestsBasilisk) | 2 | Python | 2026-08-11 | Open-source autonomous AI pentester that proves every exploit — 87/113 on OWASP Juice Shop, black-box, on a budget model |
...
| 19 | [HolmesGPT/holmesgpt](https://github.com/HolmesGPT/holmesgpt) | 3038 | Python | 2026-08-11 | SRE Agent - CNCF Sandbox Project |
...
| 21 | [iammonth1997/paperwiki-research-compiler](https://github.com/iammonth1997/paperwiki-research-compiler) | 2 | HTML | 2026-08-11 | AI Research Wiki 2026: Auto-Building Knowledge Base with Deep Citation Syntheses |
| 22 | [mrdron1314-afk/jupyter-llm-assistant](https://github.com/mrdron1314-afk/jupyter-llm-assistant) | 0 | Python | 2026-08-11 | Локальный LLM-ассистент для Jupyter с tool calling: 16 инструментов для кода, HDFS, Hive, CSV, Excel, работает через Oll |
...
| 35 | [nitinmms/LitosAiCodingAgent](https://github.com/nitinmms/LitosAiCodingAgent) | 3 | C# | 2026-08-11 | Litos is a real AI coding agent written entirely in C#/.NET, no black box. |
| 36 | [linynZ/chrono-npc-agent](https://github.com/linynZ/chrono-npc-agent) | 0 | Python | 2026-08-11 | Runtime LLM agent for game NPCs: persona and player-state injection, tool calls, guardrails that survived live testing,  |
| 37 | [areal-project/AReaL](https://github.com/areal-project/AReaL) | 5653 | Python | 2026-08-11 | The RL Bridge for LLM-based Agent Applications. Made Simple & Flexible. |
| 38 | [jshsakura/oc-korea-weather-time-mcp](https://github.com/jshsakura/oc-korea-weather-time-mcp) | 0 | Python | 2026-08-11 | LLM 에이전트를 위한 한국 날씨·시간 MCP 서버 — 기상청 단기예보 + 시간대 조회 \| Korean weather & time MCP server for LLM agents |
...
| 46 | [222394/SkyPilot](https://github.com/222394/SkyPilot) | 0 | Java | 2026-08-11 | Automate Elytra flight, navigation, and landing for Meteor Client with intelligent pathfinding and rocket management. |
| 47 | [randomvariablewhitepelican129/open_deep_research](https://github.com/randomvariablewhitepelican129/open_deep_research) | 0 | Python | 2026-08-11 | Build open source deep research agents using multiple models, search tools, and MCP servers. |
| 48 | [pruthviraj00007/VibeHarness](https://github.com/pruthviraj00007/VibeHarness) | 0 | Python | 2026-08-11 | Automate file management and coding tasks in your local directory using small language models. |
| 49 | [80x24/nuanua](https://github.com/80x24/nuanua) | 0 | TypeScript | 2026-08-11 | 메신저로 대화하는 나만의 AI 에이전트 — claude -p를 구독 인증으로 감싸 추가 비용 없이 돌리는 personal agent harness (Hermes 5기둥 + 승인 게이트 drift 방지) |
| 50 | [Respiratorysyncytialviruscoliphage228/GPU-Fleet](https://github.com/Respiratorysyncytialviruscoliphage228/GPU-Fleet) | 0 | Go | 2026-08-11 | Monitor multiple NVIDIA GPU machines from a single web dashboard to track hardware utility, temperature, and process mem |
<!-- TRACKER_TABLE_END -->
