...
| 20 | [nitinmms/LitosAiCodingAgent](https://github.com/nitinmms/LitosAiCodingAgent) | 3 | C# | 2026-08-11 | Litos is a real AI coding agent written entirely in C#/.NET, no black box. |
| 21 | [linynZ/chrono-npc-agent](https://github.com/linynZ/chrono-npc-agent) | 0 | Python | 2026-08-11 | Runtime LLM agent for game NPCs: persona and player-state injection, tool calls, guardrails that survived live testing,  |
| 22 | [acmiyaguchi/fen-web](https://github.com/acmiyaguchi/fen-web) | 0 | TypeScript | 2026-08-11 | Browser-resident fen: WASM demo + extension, consuming fen core as a submodule (fen#99) |
...
| 26 | [jshsakura/oc-korea-weather-time-mcp](https://github.com/jshsakura/oc-korea-weather-time-mcp) | 0 | Python | 2026-08-11 | LLM 에이전트를 위한 한국 날씨·시간 MCP 서버 — 기상청 단기예보 + 시간대 조회 \| Korean weather & time MCP server for LLM agents |
| 27 | [g761007/daily-dispatch](https://github.com/g761007/daily-dispatch) | 0 | Python | 2026-08-11 | 每日新聞自動分析與摘要系統：Claude Code 雲端排程（routines）定時分析、彙整成每日摘要，透過 GitHub Pages 公開發布並用 Telegram 推播。 |
| 28 | [muhammadalicusit56-glitch/otto-cognitive-nudge](https://github.com/muhammadalicusit56-glitch/otto-cognitive-nudge) | 159 | HTML | 2026-08-11 | Smart Promise Tracker AI 2026 – Commit Memory Engine |
| 29 | [forger-labs-hq/researchforge](https://github.com/forger-labs-hq/researchforge) | 4 | Python | 2026-08-11 | Autonomous AI agent & benchmarking CLI for Claude Code and Cursor. Build, validate, and ship research hypotheses repos — |
| 30 | [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | 28811 | Python | 2026-08-11 | Build and run agents you can see, understand and trust. |
...
| 34 | [alejandrogg15/Minimax-H3-Turbo](https://github.com/alejandrogg15/Minimax-H3-Turbo) | 0 | Python | 2026-08-11 | Accelerate MiniMax-H3 video generation with batch inference and optimized NFE/LoRA comparisons. |
| 35 | [Aureliedumbfounding630/agent-governance-toolkit](https://github.com/Aureliedumbfounding630/agent-governance-toolkit) | 0 | — | 2026-08-11 | Manage and monitor AI agents in production environments with tools for governance, safety, and compliance. |
| 36 | [222394/SkyPilot](https://github.com/222394/SkyPilot) | 0 | Java | 2026-08-11 | Automate Elytra flight, navigation, and landing for Meteor Client with intelligent pathfinding and rocket management. |
| 37 | [randomvariablewhitepelican129/open_deep_research](https://github.com/randomvariablewhitepelican129/open_deep_research) | 0 | Python | 2026-08-11 | Build open source deep research agents using multiple models, search tools, and MCP servers. |
| 38 | [pruthviraj00007/VibeHarness](https://github.com/pruthviraj00007/VibeHarness) | 0 | Python | 2026-08-11 | Automate file management and coding tasks in your local directory using small language models. |
| 39 | [80x24/nuanua](https://github.com/80x24/nuanua) | 0 | TypeScript | 2026-08-11 | 메신저로 대화하는 나만의 AI 에이전트 — claude -p를 구독 인증으로 감싸 추가 비용 없이 돌리는 personal agent harness (Hermes 5기둥 + 승인 게이트 drift 방지) |
| 40 | [Respiratorysyncytialviruscoliphage228/GPU-Fleet](https://github.com/Respiratorysyncytialviruscoliphage228/GPU-Fleet) | 0 | Go | 2026-08-11 | Monitor multiple NVIDIA GPU machines from a single web dashboard to track hardware utility, temperature, and process mem |
| 41 | [Samuelcluttered613/paper2code](https://github.com/Samuelcluttered613/paper2code) | 1 | Python | 2026-08-11 | Convert arXiv papers into citation-linked codebases with reproducible notes and implementation files |
| 42 | [xhqing/DayTradingAgent](https://github.com/xhqing/DayTradingAgent) | 1 | Python | 2026-08-11 | AI day-trading agent that watches markets, emits structured trade signals, and auto-executes trades across HK / US / A-s |
...
| 44 | [tessellated-statisticalcommission243/deep-research-skill](https://github.com/tessellated-statisticalcommission243/deep-research-skill) | 3 | — | 2026-08-11 | Deliver deep research with a 5-layer Claude skill for markets, products, competitors, regulations, and opportunities |
| 45 | [chadwickhyperboloidal943/knowl](https://github.com/chadwickhyperboloidal943/knowl) | 0 | TypeScript | 2026-08-11 | Build autonomous voice agents with Next.js, React, Vapi, ElevenLabs, and Gemini for natural, real-time conversations |
| 46 | [Laurenfeminine36/google-jules-skill](https://github.com/Laurenfeminine36/google-jules-skill) | 1 | Python | 2026-08-11 | Control Google Jules sessions via REST API and CLI, enabling session management, status checks, instructions, reports, m |
| 47 | [Jssu8541/ouro-loop](https://github.com/Jssu8541/ouro-loop) | 0 | — | 2026-08-11 | Provide AI coding agents with a structured autonomous loop that enforces runtime guardrails for safer, more reliable ope |
| 48 | [codedpro/agentic-game-factory](https://github.com/codedpro/agentic-game-factory) | 2 | GDScript | 2026-08-11 | An AI agent builds complete mobile games end to end — design, code, art, music, 136 headless tests, store assets, in-app |
| 49 | [Asim00740/Kagantic-vault-structure](https://github.com/Asim00740/Kagantic-vault-structure) | 0 | — | 2026-08-11 | Provide a structured template for Obsidian-style markdown vaults to improve LLM agent navigation and human readability i |
| 50 | [Tonyx79/clov-ai](https://github.com/Tonyx79/clov-ai) | 0 | Rust | 2026-08-11 | Manage and filter AI context and outputs locally using Rust-powered tools for precise control and improved response qual |
<!-- TRACKER_TABLE_END -->
