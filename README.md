...
| 36 | [y0usaf/pi-rs](https://github.com/y0usaf/pi-rs) | 0 | Rust | 2026-08-06 | Pi's coding agent ported to Rust |
| 37 | [ljchang/mecha](https://github.com/ljchang/mecha) | 0 | Rust | 2026-08-06 | A standalone agent harness in Rust: a provider-agnostic loop, MCP tools, a path jail and prompt-injection interlock, san |
...
| 39 | [xhqing/PersonalAssistantAgent](https://github.com/xhqing/PersonalAssistantAgent) | 0 | Shell | 2026-08-06 | 个人助理 Kit｜通用助手。Personal Assistant — a general-purpose helper for odd jobs. |
| 40 | [AlanFokCo/agentscope-go](https://github.com/AlanFokCo/agentscope-go) | 27 | Go | 2026-08-06 | AgentScope Golang: Agent-Oriented Programming for Building LLM Applications |
| 41 | [ongridio/ongrid](https://github.com/ongridio/ongrid) | 610 | Go | 2026-08-06 | An ops AI Agent that understands your infrastructure, finds the root cause, and fixes it — right from Slack, Telegram, L |
| 42 | [K611-dot/quant-analyst-agent](https://github.com/K611-dot/quant-analyst-agent) | 0 | Python | 2026-08-06 | Autonomous equity-research agent: a ticker in, a sourced investment memo out. Claude tool-use loop over SEC EDGAR + mark |
...
| 44 | [eshanized/M31A](https://github.com/eshanized/M31A) | 8 | Go | 2026-08-06 | The terminal-native AI coding agent that ships, not just suggests. Six-phase workflow, git rollback chain, zero telemetr |
...
| 47 | [hoshiyomiX/stellar-trails](https://github.com/hoshiyomiX/stellar-trails) | 0 | Shell | 2026-08-06 | Universal task workflow for LLM agents — phase state machine with traceability IDs, artifact templates, source state ver |
| 48 | [gptme/gptme](https://github.com/gptme/gptme) | 4374 | Python | 2026-08-06 | Your agent in your terminal, equipped with local tools: writes code, uses the terminal, browses the web. Make your own p |
| 49 | [yo4e/sudachi-life](https://github.com/yo4e/sudachi-life) | 0 | Python | 2026-08-06 | A lightweight artificial life that learns to replace parent-model reasoning with local memory, skills, and routines. |
| 50 | [tachyon-r/maximal-utility-agent-soul](https://github.com/tachyon-r/maximal-utility-agent-soul) | 1 | — | 2026-08-06 | A framework-agnostic maximal-utility agent SOUL for autonomous AI agents. |
<!-- TRACKER_TABLE_END -->
